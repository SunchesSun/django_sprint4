# Generated by Django 3.2.16 on 2025-04-22 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(help_text='Если уставновить дату и время в будущем -можно делать отложенные публикации.', verbose_name='Дата и время публикации')),
